 ...
 */
public class com.svincent.moksa.prolog.parser_prolog.parse_prolog_more_args_4_alt1
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.parse_prolog_more_args_4_alt1 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg ArgList
    //  --- ArgList
    var_5 = factory.makeVariable((java.lang.String)"ArgList");
    ...
    //  --- MoreArgTokens
    var_8 = factory.makeVariable((java.lang.String)"MoreArgTokens");
    ...
    //  --- MoreArgs
    var_10 = factory.makeVariable((java.lang.String)"MoreArgs");
    //  --- parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail)
    compound_11 = factory.makeCompoundTerm((java.lang.String)"parse_prolog_more_args", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_8, var_4, var_10, var_6});
    //  --- [Exp | MoreArgs]
    ...
    //  --- ','(parse_prolog_exp(Rest, Priority, Exp, MoreArgTokens), ','(parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail), '='(ArgList, [Exp | MoreArgs])))
  ...
  {
    return "parse_prolog_more_args/4";
  }
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    compound_7 = factory.makeCompoundTerm((java.lang.String)"parse_prolog_more_args", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {compound_3, var_4, var_5, var_6});
    //  --- Exp
    var_8 = factory.makeVariable((java.lang.String)"Exp");
    //  --- MoreArgTokens
    var_9 = factory.makeVariable((java.lang.String)"MoreArgTokens");
    //  --- parse_prolog_exp(Rest, Priority, Exp, MoreArgTokens)
    ...
    //  --- MoreArgs
    var_11 = factory.makeVariable((java.lang.String)"MoreArgs");
    //  --- parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail)
    compound_12 = factory.makeCompoundTerm((java.lang.String)"parse_prolog_more_args", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_9, var_4, var_11, var_6});
    //  --- [Exp | MoreArgs]
    ...
    //  --- ':-'(parse_prolog_more_args([name(,) | Rest], Priority, ArgList, Tail), ','(parse_prolog_exp(Rest, Priority, Exp, MoreArgTokens), ','(parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail), '='(ArgList, [Exp | MoreArgs]))))
