 ...
 * 
 * File generated: Thursday, December 2, 1999 8:07:28 AM EST
 */
public class com.svincent.moksa.prolog.parser_prolog.current_op_3_alt25
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.current_op_3_alt25 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg 500
    //  --- 500
    int_0 = factory.makeInteger((int)500);
    if (wam.badparm((int)0, (com.svincent.moksa.PrologTerm)int_0))
      return wam.Fail;
    //  *** test arg yfx
    //  --- yfx
    compound_1 = factory.makeAtom((java.lang.String)"yfx");
