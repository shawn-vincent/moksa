 ...
 */
public class com.svincent.moksa.prolog.parser_prolog.parse_prolog_arg_list_4
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.parse_prolog_arg_list_4 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg ArgList
    //  --- ArgList
    var_2 = factory.makeVariable((java.lang.String)"ArgList");
    ...
    //  --- MoreArgTokens
    var_5 = factory.makeVariable((java.lang.String)"MoreArgTokens");
    ...
    //  --- MoreArgs
    var_7 = factory.makeVariable((java.lang.String)"MoreArgs");
    //  --- parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail)
    compound_8 = factory.makeCompoundTerm((java.lang.String)"parse_prolog_more_args", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_5, var_1, var_7, var_3});
    //  --- [Exp | MoreArgs]
    ...
    //  --- ','(parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail), '='(ArgList, [Exp | MoreArgs]))
    ...
    //  --- ','(parse_prolog_exp(Tokens, Priority, Exp, MoreArgTokens), ','(parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail), '='(ArgList, [Exp | MoreArgs])))
  ...
  {
    return "parse_prolog_arg_list/4";
  }
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    compound_4 = factory.makeCompoundTerm((java.lang.String)"parse_prolog_arg_list", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_0, var_1, var_2, var_3});
    //  --- Exp
    var_5 = factory.makeVariable((java.lang.String)"Exp");
    //  --- MoreArgTokens
    var_6 = factory.makeVariable((java.lang.String)"MoreArgTokens");
    //  --- parse_prolog_exp(Tokens, Priority, Exp, MoreArgTokens)
    ...
    //  --- MoreArgs
    var_8 = factory.makeVariable((java.lang.String)"MoreArgs");
    //  --- parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail)
    compound_9 = factory.makeCompoundTerm((java.lang.String)"parse_prolog_more_args", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_6, var_1, var_8, var_3});
    //  --- [Exp | MoreArgs]
    ...
    //  --- ':-'(parse_prolog_arg_list(Tokens, Priority, ArgList, Tail), ','(parse_prolog_exp(Tokens, Priority, Exp, MoreArgTokens), ','(parse_prolog_more_args(MoreArgTokens, Priority, MoreArgs, Tail), '='(ArgList, [Exp | MoreArgs]))))
