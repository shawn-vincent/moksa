 ...
 */
public class com.svincent.moksa.prolog.parser_prolog.parse_prolog_term_4_alt1
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.parse_prolog_term_4_alt1 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg [float(Number) | Rest]
    //  --- Number
    var_0 = factory.makeVariable((java.lang.String)"Number");
    //  --- float(Number)
    compound_1 = factory.makeCompoundTerm((java.lang.String)"float", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_0});
    //  --- Rest
    ...
    //  --- is(Term, Number)
    compound_8 = factory.makeCompoundTerm((java.lang.String)"is", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_5, var_0});
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    //  --- is(Term, Number)
    compound_9 = factory.makeCompoundTerm((java.lang.String)"is", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_5, var_0});
    //  --- ','('>='(Priority, 0), is(Term, Number))
    ...
    //  --- ':-'(parse_prolog_term([float(Number) | Rest], Priority, Term, Rest), ','('>='(Priority, 0), is(Term, Number)))
