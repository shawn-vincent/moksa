 ...
 */
public class com.svincent.moksa.prolog.parser_prolog.calculate_prolog_infix_subpriority_4
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.calculate_prolog_infix_subpriority_4 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg xfx
    //  --- xfx
    compound_0 = factory.makeAtom((java.lang.String)"xfx");
    ...
    //  --- '-'(P, 1)
    compound_7 = factory.makeCompoundTerm((java.lang.String)"-", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_1, int_4});
    //  --- is(BP, '-'(P, 1))
    ...
    //  --- ','(is(AP, '-'(P, 1)), is(BP, '-'(P, 1)))
    compound_9 = factory.makeCompoundTerm((java.lang.String)",", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {compound_6, compound_8});
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    //  --- '-'(P, 1)
    compound_8 = factory.makeCompoundTerm((java.lang.String)"-", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_1, int_5});
    //  --- is(BP, '-'(P, 1))
    compound_9 = factory.makeCompoundTerm((java.lang.String)"is", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_3, compound_8});
    //  --- ','(is(AP, '-'(P, 1)), is(BP, '-'(P, 1)))
    compound_10 = factory.makeCompoundTerm((java.lang.String)",", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {compound_7, compound_9});
    //  --- ':-'(calculate_prolog_infix_subpriority(xfx, P, AP, BP), ','(is(AP, '-'(P, 1)), is(BP, '-'(P, 1))))
    compound_11 = factory.makeCompoundTerm((java.lang.String)":-", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {compound_4, compound_10});
    return compound_11;
  }
