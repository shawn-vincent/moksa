 ...
 */
public class com.svincent.moksa.prolog.parser_prolog.parse_prolog_term_4_alt3
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.parse_prolog_term_4_alt3 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg [name(-), float(Number) | Rest]
    //  --- -
    ...
    //  --- float(Number)
    compound_3 = factory.makeCompoundTerm((java.lang.String)"float", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_2});
    //  --- Rest
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    //  --- ':-'(parse_prolog_term([name(-), float(Number) | Rest], Priority, Term, Rest), ','('>='(Priority, 0), is(Term, '-'(Number))))
