 ...
 */
public class com.svincent.moksa.prolog.parser_prolog.calculate_prolog_postfix_subpriority_3_alt1
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.parser_prolog.calculate_prolog_postfix_subpriority_3_alt1 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  *** test arg yf
    //  --- yf
    compound_0 = factory.makeAtom((java.lang.String)"yf");
  ...
  {
    return "calculate_prolog_postfix_subpriority/3";
  }
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    //  --- AP
    var_2 = factory.makeVariable((java.lang.String)"AP");
    //  --- calculate_prolog_postfix_subpriority(yf, P, AP)
    compound_3 = factory.makeCompoundTerm((java.lang.String)"calculate_prolog_postfix_subpriority", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {compound_0, var_1, var_2});
    //  --- is(AP, P)
