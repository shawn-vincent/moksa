 ...
 */
public class com.svincent.moksa.prolog.system_prolog.put_char_1
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.system_prolog.put_char_1 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  --- put_char(S, Char)
    compound_3 = factory.makeCompoundTerm((java.lang.String)"put_char", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_1, var_0});
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    var_0 = factory.makeVariable((java.lang.String)"Char");
    //  --- put_char(Char)
    compound_1 = factory.makeCompoundTerm((java.lang.String)"put_char", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_0});
    //  --- S
    ...
    //  --- put_char(S, Char)
    compound_4 = factory.makeCompoundTerm((java.lang.String)"put_char", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_2, var_0});
    //  --- ','(current_output(S), put_char(S, Char))
