 ...
 */
public class com.svincent.moksa.prolog.system_prolog.nl_0
  extends com.svincent.moksa.CompiledRule
{
  public com.svincent.moksa.prolog.system_prolog.nl_0 ()
  {
  }
    ...
    throws com.svincent.moksa.PrologException
  {
    ...
    //  --- nl(S)
    compound_2 = factory.makeCompoundTerm((java.lang.String)"nl", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_0});
  ...
  public com.svincent.moksa.PrologTerm makeTerm (com.svincent.moksa.PrologFactory factory)
  {
    ...
    //  --- nl
    compound_0 = factory.makeAtom((java.lang.String)"nl");
    //  --- S
    ...
    //  --- nl(S)
    compound_3 = factory.makeCompoundTerm((java.lang.String)"nl", (com.svincent.moksa.PrologTerm[])new com.svincent.moksa.PrologTerm[] {var_1});
    //  --- ','(current_output(S), nl(S))
