 ...
 *  <p>
 *  Edited and adopted in January 1998 by
 *  <a href="http://www.svincent.com/">Shawn Vincent</a>,
 *  <a href="mailto:svincent@svincent.com">svincent@svincent.com</a>
 *  -  mostly just stole the code, but added a few new useful functions,
 *     etc.
 *  
 *  @see java.util.Random
 */
public abstract class RandomX extends Random {
  ...
  public int nextInt() 
  {
    return (int) ((((int) nextShort()) << 16) | 
		  (((int) nextShort()) & 0xFFFF));
  }
  ...
  /**
   * A little test routine, trying out this kewl true random numbers stuff.
   */
  public static void main (String [] argv)
  {
    RandomX randomGenerator = new RandomHotBits ();
    for (int i=0; i<100; i++)
