 ...
 */
public class ReflectException extends NestableException {
  public ReflectException () { super (); }
  public ReflectException (String msg) { super (msg); }
  public ReflectException (String msg, Throwable ex) { super (msg, ex); }
}
