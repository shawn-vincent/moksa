 ...
 * -------------------------------------------------------------------------
 *
 * SmallJavaBuildingException.java
 * 
 */
 ...
 */
public class SmallJavaBuildingException extends NestableException {
  public SmallJavaBuildingException () { super (); }
  public SmallJavaBuildingException (String msg) { super (msg); }
  public SmallJavaBuildingException (String msg, Throwable ex) 
  { super (msg, ex); }
}
