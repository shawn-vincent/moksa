...
import com.svincent.util.NestableRuntimeException;
...
public class ClassFileWriter extends LabelTable {
    ...
    public void stopMethod(short maxLocals, VariableTable vars) {
        ...
        // XXX what about checking and giving error if maxLocals is
        // XXX different than 'vars.size ()+1', etc???
        ...
        Util.assertTrue (itsCodeBuffer != null, 
                     "No code was added to the code buffer!");

        System.arraycopy(itsCodeBuffer, 0, 
                         codeAttribute, index, 
                         itsCodeBufferTop);
        ...
        if (vars != null) {
            ...
            for (int i = 0; i < varCount; i++) {
                ...
                // descriptor index
                int descriptorIndex =
                    itsConstantPool.addUtf8(lvar.getTypeDescriptor ());
//                                          lvar.isNumber() 
//                                          ? "D"
//                                          :  "Ljava/lang/Object;");
                ...
                // SPV: this was not apparently correct.
                // BUT: how could this EVER have worked?  XXX
                int jreg = lvar.getIndex();
        ...
        if (theIndex == null) {
            ...
            try {
                ...
                throw new NestableRuntimeException 
                    ("Got I/O Exception generating UTF8 string", iox);
            }
        }
