 ...
 * Shawn Vincent
 * -------------
 *    Added type information to local variable.
 */
...
public class LocalVariable {
    ...
    public LocalVariable(String name, boolean isParameter, String type) {
        itsName = name;
    ...
    /** Retrieve the type descriptor for this Local Variable. */
